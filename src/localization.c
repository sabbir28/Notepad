...
static const LocEntry kLocTable[] = {
    ...
    { LOC_LINUX_CONSOLE_TITLE, L"NotepadLite (Linux GUI)", L"নোটপ্যাড লাইট (লিনাক্স জিইউআই)" },
    { LOC_USAGE, L"Usage: %s [file]", L"ব্যবহার: %s [file]" },
    { LOC_USAGE_DETAIL, L"If a file is provided, it will be opened in the editor.", L"একটি ফাইল দিলে তা এডিটরে খোলা হবে।" },
    { LOC_USAGE_EOF, L"Close the window to exit.", L"বন্ধ করতে উইন্ডোটি বন্ধ করুন।" },
...
static const LocEntry kLocTable[] = {
    ...
    { LOC_LINUX_CONSOLE_TITLE, "NotepadLite (Linux GUI)", "নোটপ্যাড লাইট (লিনাক্স জিইউআই)" },
    { LOC_USAGE, "Usage: %s [file]", "ব্যবহার: %s [file]" },
    { LOC_USAGE_DETAIL, "If a file is provided, it will be opened in the editor.", "একটি ফাইল দিলে তা এডিটরে খোলা হবে।" },
    { LOC_USAGE_EOF, "Close the window to exit.", "বন্ধ করতে উইন্ডোটি বন্ধ করুন।" },
